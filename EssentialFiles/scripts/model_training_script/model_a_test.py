...
def create_keras_model(nBinsX, nBinsY,model_loss_weight=[1.0,1.0],regression_act_type='relu'):
    ...
    merge = Concatenate()([bn_r,regression_output])
    dense4 = Dense(40,activation='relu')(merge)
...
def main():
    ...
    OUTDIR = 'model_a_layer_size_test'           # Set to the name of the folder where you will save your models
    MODELDIR = '20240227--203709'    # If FINETUNE is true or Train is false and Test is true, MODELDIR must be specified as the dt_string of the model to be finetuned / tested or an error will occur
