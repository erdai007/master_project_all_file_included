...
def create_keras_model(nBinsX, nBinsY,model_loss_weight=[1.0,1.0],regression_act_type='relu'):
    ...
    regression_output = Dense(1, activation=regression_act_type,name="regression_output")(final_bn)
...
def main():
    ...
    OUTDIR = 'Ht_trigg_rate-test'           # Set to the name of the folder where you will save your models
    MODELDIR = '20240305--160556'    # If FINETUNE is true or Train is false and Test is true, MODELDIR must be specified as the dt_string of the model to be finetuned / tested or an error will occur
